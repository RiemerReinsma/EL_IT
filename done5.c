...
void brudtStreg1b()
{
	...
	sleep(950);                            //er længere end 1a, fordi den skal ende på venstre side af den sorte streg.
}
...
void findFlaske5()
{
	while(getUSDistance(ultra)>55)          //søger efter flaske
	{
		setMotorSpeed(venstre,-5);
		setMotorSpeed(hoejre,5);
	}
	setMotorSpeed(venstre,-4);              //drejer lidt ekstra, da sensoren ikke sidder helt i midten :)
...

{
	...
	while(true)
	{
			playSoundFile("/home/root/lms2012/prjs/1_1");
	playSoundFile("/home/root/lms2012/prjs/2_2");
	playSoundFile("/home/root/lms2012/prjs/3_3");
	playSoundFile("/home/root/lms2012/prjs/4_4");
	playSoundFile("/home/root/lms2012/prjs/5_5");
	playSoundFile("/home/root/lms2012/prjs/6_6");
	playSoundFile("/home/root/lms2012/prjs/7_7");
	playSoundFile("/home/root/lms2012/prjs/8_8");
	playSoundFile("/home/root/lms2012/prjs/9_9");
	playSoundFile("/home/root/lms2012/prjs/10_0");
	playSoundFile("/home/root/lms2012/prjs/11_1");
	//clearSounds();
	playSoundFile("/home/root/lms2012/prjs/12_2");
	playSoundFile("/home/root/lms2012/prjs/13_3");
	playSoundFile("/home/root/lms2012/prjs/14_4");
	playSoundFile("/home/root/lms2012/prjs/15_5");
	playSoundFile("/home/root/lms2012/prjs/16_6");
	playSoundFile("/home/root/lms2012/prjs/17_7");
		...
		else if (getUSDistance(ultra)<6 && sort<8)
		{
			loeftFlaske2();
			sort=7;
		}
		...
		else if(sort==29)
		{
			...
			while(time1[T1]<11900)              //uret sættes til 11.7 sekunder - det passer med at robotten er midt på landingsbanen
			{
				landingsbanen8();
			}
			sort=sort+1;
